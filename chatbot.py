...
if __name__ == "__main__":
	...
	assert isinstance(team_by_name(["lebron james"]), list), "teams_by_name not returning a list"
	assert sorted(team_by_name(["lebron james"])) == sorted(
         ["los angeles lakers"]
    ), "failed teams_by_name test"
	assert isinstance(teams_by_name(["lebron james"]), list), "teams_by_name not returning a list"
	assert sorted(teams_by_name(["lebron james"])) == sorted(
         [
            "miami heat",
            "cleveland cavaliers",
         ]
